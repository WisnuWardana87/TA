                ...
                <div class="col-12">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="<?= site_url('Prestasi/register_tingkat') ?>"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-folder-plus"></i> Tambah Data</button></a>
                        </div>
                    </div>
                    <div class="card">
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($tingkat as $val) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?= site_url('Prestasi/update_register_tingkat/' . md5($val['id_tingkat'])) ?>">
