                ...
                <div class="col-12">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="<?= site_url('Prestasi/register_jenis') ?>"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-folder-plus"></i> Tambah Data</button></a>
                        </div>
                    </div>
                    <div class="card">
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($jenis as $val) { ?>
                                        <tr>
                                            ...
                                            <td><?= $val['ket_jenis']; ?></td>
                                            <td class="text-center"><a href="<?= site_url('Prestasi/update_register_jenis/' . md5($val['id_jenis'])) ?>">
