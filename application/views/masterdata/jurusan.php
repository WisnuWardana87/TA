                ...
                <div class="col-12">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="<?= site_url('MasterData/register_jurusan') ?>"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-folder-plus"></i> Tambah Data</button></a>
                        </div>
                    </div>
                    <div class="card">
                        <!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($jurusan as $val) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="<?= site_url('MasterData/update_register_jurusan/' . md5($val['id_jurusan'])) ?>">
