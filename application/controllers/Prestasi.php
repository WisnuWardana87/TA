...
class Prestasi extends CI_Controller
{
    ...
    function register_bidang()
    {
        $data['title'] = "Register Data Bidang Prestasi";
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_bidang', $data);
        $this->load->view('templates/footer');
    }

    public function update_register_bidang($id_bidang)
    {
        $data['title'] = "Registrasi";
        $this->db->where('md5(id_bidang)', $id_bidang);
        $data['id_bidang'] = $this->db->get('tb_bidang')->row_array();
    ...
    public function save_register_bidang()
    {
        if ($_POST['id_bidang'] != '') {
    ...
    public function register_jenis()
    {
        $data['title'] = "Register Data Jenis Prestasi";
        $data['nama_bidang'] = $this->M_prestasi->data_bidang();
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_jenis', $data);
        $this->load->view('templates/footer');
    }
    public function update_register_jenis($id_jenis)
    {
        $data['title'] = "Registrasi Jurusan";
        $this->db->where('md5(id_jenis)', $id_jenis);
        $data['id_jenis'] = $this->db->get('tb_jenis_prestasi')->row_array();
        $data['nama_bidang'] = $this->M_prestasi->data_bidang();
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
    ...
    public function save_register_jenis()
    {
        if ($_POST['id_jurusan'] != '') {
    ...
    function register_tingkat()
    {
        $data['title'] = "Register Data Tingkat Prestasi";
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_tingkat', $data);
        $this->load->view('templates/footer');
    }

    public function update_register_tingkat($id_tingkat)
    {
        $data['title'] = "Registrasi";
        $this->db->where('md5(id_tingkat)', $id_tingkat);
        $data['id_tingkat'] = $this->db->get('tb_tingkat')->row_array();
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_tingkat', $data);
    ...
    public function save_register_tingkat()
    {
        if ($_POST['id_tingkat'] != '') {
    ...
    function register_jenis_juara()
    {
        $data['title'] = "Register Data Jenis Juara";
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_jenis_juara', $data);
        $this->load->view('templates/footer');
    }

    public function update_register_jenis_juara($id_jenis_juara)
    {
        $data['title'] = "Registrasi";
        $this->db->where('md5(id_jenis_juara)', $id_jenis_juara);
        $data['id_jenis_juara'] = $this->db->get('tb_jenis_juara')->row_array();
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('prestasi/register_jenis_juara', $data);
    ...
    public function save_register_jenis_juara()
    {
        if ($_POST['id_tingkat'] != '') {
